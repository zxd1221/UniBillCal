...
@pytest.fixture
def alipay_raw_df():
    """模拟支付宝原始账单数据（Excel 导出格式）
    旗舰店A 在 2024-01-05 有两条记录（ALI001 + ALI006），
    合计 6 条原始行 -> 汇总后 5 个 (date, store) 组合。
    """
    return pd.DataFrame({
        "交易时间": ["2024-01-05", "2024-01-05", "2024-01-05", "2024-01-06", "2024-01-06", "2024-01-07"],
        "商家名称":  ["旗舰店A", "旗舰店A", "旗舰店B", "旗舰店A", "旗舰店C", "旗舰店B"],
        "商户订单号": ["ALI001", "ALI006", "ALI002", "ALI003", "ALI004", "ALI005"],
